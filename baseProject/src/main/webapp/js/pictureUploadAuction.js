function showPictures() {
	$.post('/profile/placeAuction/getUploadedPictures', function(data) {
...
$(function() {
	$('#field-pictures').fileupload({
		url : '/profile/placeAuction/uploadPictures',
		dataType : 'json',
	...
	$("table").on("click", "td[data-delete-url]", function(event) {
		...
		$.post('/profile/placeAuction/deletePicture', {url : deleteUrl}, function() {
			showPictures();
		});
	});
});
