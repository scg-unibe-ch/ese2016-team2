function showPictures() {
	$.post('/profile/editAuction/getUploadedPictures', function(data) {
...
$(function() {
	$('#field-pictures').fileupload({
		url : '/profile/editAuction/uploadPictures',
		dataType : 'json',
	...
	$("table").on("click", "td[data-delete-url]", function(event) {
		...
		$.post('/profile/editAuction/deletePicture', {url : deleteUrl}, function() {
			showPictures();
		});
	});
});
