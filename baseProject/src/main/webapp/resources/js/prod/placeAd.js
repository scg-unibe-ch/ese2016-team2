...
jQuery.flatfindr.register({
  ...
  /**
   * @memberof jQuery.flatfindr.header
   * @method fn
   *
   * @protected
...
// @Jerome
// NB: Adding specific components instead of the entire ui.js does not seem
...
// @codekit-prepend "../../components/blueimp-load-image/js/load-image.all.min.js"
// @codekit-prepend "../../components/blueimp-file-upload/js/jquery.iframe-transport.js"
