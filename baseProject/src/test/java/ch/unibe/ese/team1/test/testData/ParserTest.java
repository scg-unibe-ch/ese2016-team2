...
public class ParserTest {
	...
	public void saveFromAndGetByUser() throws ParseException {
		...
		User hans = createUser("Parser@Test.ch", "password", "Parser", "Test", Gender.MALE, "Premium");
		hans.setAboutMe("Parser Test");
		userDao.save(hans);
	...
	private User createUser(final String email, final String password, final String firstName, final String lastName,
			final Gender gender, final String account) {
		User user = new User();
