...
public class AdTestDataSaver {
	...
	public void saveTestData() throws Exception {
		...
		adNeuchâtel.setTitle("Studio extrâmement bon marchâ ââ Neuchâtel");
		adNeuchâtel.setStreet("Rue de l'Hâpital 11");
		...
		String studioDescription11 = "Studio meublé au 3iéme étage, comprenant"
				+ "une kitchenette entiérement équiée (frigo, plaques,"
				+ "four et hotte), une pièce à vivre donnant sur un balcon,"
				+ "une salle de bains avec wc. Cave, buanderie et site satellite"
				+ "à disposition.";
