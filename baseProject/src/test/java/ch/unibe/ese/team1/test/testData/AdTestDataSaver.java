...
public class AdTestDataSaver {
	...
	public void saveTestData() throws Exception {
		...
		adNeuchatel.setRoommates("None");
		adNeuchatel.setUser(bernerBaer);
		adNeuchatel.setTitle("Studio extr�mement bon march� � Neuch�tel");
		adNeuchatel.setStreet("Rue de l'H�pital 11");
		adNeuchatel.setCity("Neuch�tel");
		...
		adBiel.setUser(ese);
		adBiel.setTitle("Direkt am Quai: h�bsches Studio");
